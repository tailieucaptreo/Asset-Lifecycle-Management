...
function buildManualDeviceData(d, oldDevice = null) {
     ...
     *
     * Khi UPDATE:
     *     luôn giữ originalInstallDate cũ.
     *
     * Nếu DB chưa có originalInstallDate
     * nhưng có installDate cũ thì lấy installDate cũ
     * làm ngày lắp lần đầu.
     *
     * Khi CREATE:
    ...
    let originalInstallDate = null;

    if (oldDevice) {

        originalInstallDate =
            oldDevice.originalInstallDate ||
            oldDevice.installDate ||
            null;
     ...
     *
     * Nếu có thay thế:
     *     tính lại từ ngày thay thế.
     *
     * Nếu không:
     *     giữ ngày hết hạn được nhập.
     *
     * Nếu không có expiryDate:
     *     tự tính từ installDate.
     * =====================================================
     */
     ...
     * STATUS
     *
     * Có ngày thay thế mới
     * → thiết bị trở lại hoạt động.
     * =====================================================
     */
